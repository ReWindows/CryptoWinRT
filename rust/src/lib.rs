//! Windissect-generated Rust FFI bindings for CryptoWinRT.dll. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "CD1CF87037A31E2FC8A853012B8D2018";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 2213376112;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 16] = [67, 114, 121, 112, 116, 111, 87, 105, 110, 82, 84, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 2213376112 { return 0; }
