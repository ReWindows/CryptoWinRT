...
static constexpr wchar_t module_name[16] = {0x0043, 0x0072, 0x0079, 0x0070, 0x0074, 0x006F, 0x0057, 0x0069, 0x006E, 0x0052, 0x0054, 0x002E, 0x0064, 0x006C, 0x006C, 0x0000};
...
if (live_timestamp != 2213376112U || rva >= image_size) return nullptr;
return base + rva;
}
